...
class AnchorHead(BaseDenseHead, BBoxTestMixin):
    ...
    def get_anchors(self, featmap_sizes, img_metas, device='cuda'):
        ...
        multi_level_anchors = self.prior_generator.grid_priors(featmap_sizes, device=device)  # 生成先验框
        anchor_list = [multi_level_anchors for _ in range(num_imgs)]  # 不同输入图像所对应FPN各个输出特诊所对应的先验框
